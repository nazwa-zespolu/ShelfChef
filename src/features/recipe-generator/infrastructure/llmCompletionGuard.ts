...
import { categorizationBatchSize, maxDishes } from '../../../RecipeGeneratorView';
const IM_END = '<|' + 'im_end' + '|>';
...
const DEFAULT_MAX_TOKENS: Record<LlmCompletionKind, number> = {
...
export async function boundedLlmGenerate(
  ...
  const maxTokens = DEFAULT_MAX_TOKENS[kind];
